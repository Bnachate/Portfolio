...
export function Button({
  ...
  const base =
    "inline-flex items-center justify-center gap-2 rounded-xl h-12 w-32 max-w-full cursor-pointer font-medium transition-all duration-300 focus:outline-none focus:ring-2 disabled:cursor-not-allowed disabled:opacity-50";
